...
class AddFamilyMemberAdapter(
    ...
    RecyclerView.Adapter<AddFamilyMemberAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        familyDetails.firstName.let {
            holder.member_name.text = it.replace("\"", "") + " "+familyDetails.lastName.replace("\"", "")
        }
        ...
        try {
            if (familyDetails.ageGroup.replace("\"","").equals("Adult")) {
                holder.profile_picture.setImageResource(R.drawable.adult_icon)
            } else {
                holder.profile_picture.setImageResource(R.drawable.kids_icon)
            }
        }catch (ex: Exception){
            holder.profile_picture.setImageResource(R.drawable.profile)
        }
