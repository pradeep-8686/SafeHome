...
class ComplaintStatusCommunityAdapter(var context: Context, private var statesList: List<String>) :
    RecyclerView.Adapter<ComplaintStatusCommunityAdapter.MyViewHolder>() {
