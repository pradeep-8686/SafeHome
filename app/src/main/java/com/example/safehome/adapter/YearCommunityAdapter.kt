...
class YearCommunityAdapter(var context: Context, private var statesList: List<String>) :
    RecyclerView.Adapter<YearCommunityAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.ageGroupTv.setOnClickListener {
            if( context is ComplaintsActivity) {
                communityFragment.selectComplaintCommunityYear(it.tag as String)
            }
        }
    }
