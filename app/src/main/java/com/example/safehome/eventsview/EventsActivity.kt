...
import com.example.safehome.databinding.ActivityEventsBinding
...
class EventsActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        replaceFragment(R.id.vehicle_fragment_container, UpcomingFragment())
    ...
    private fun buttonClickEvents() {
        ...
        binding.upcomingBtn.setOnClickListener {
            binding.upcomingBtn.background = getDrawable(R.drawable.rectangler_vrify_bg)
        ...
        binding.historyBtn.setOnClickListener {
            ...
            binding.upcomingBtn.setBackgroundResource(0)

            replaceFragment(R.id.vehicle_fragment_container, EventsHistoryFragment())
        }
    }
