...
class CabAllowFrequentlyFragment(private val visitorTypeId: Int? = null,
   ...
   // private var scheduleId : Int ?= null
    ...
    private var sVehicleNumber: String? = ""
    ...
    private fun setIntentData() {
        if (visitorListItem != null){
            ...
            if (visitorListItem.vehicleNumber != null){
                binding.etCabNumber.text = Editable.Factory.getInstance().newEditable(visitorListItem.vehicleNumber)
            }
    ...
    private fun clickEvents() {
        ...
        binding.inviteBtn.setOnClickListener {
            ...
            if (validateData()) {
                ...
                visitorOptionsMap["VisitorTypeName"] = "Cab"
                ...
                visitorOptionsMap["VehicleNumber"] = sVehicleNumber!!
//                visitorOptionsMap["ApprovalStatusId"] = 1
    ...
    private fun validateData(): Boolean {
        ...
        sVehicleNumber = binding.etCabNumber.text.toString()
        ...
        if (sGuestName!!.isEmpty()) {
            Utils.showToast(requireContext(), "Please enter driver name")
            return false
        }
        ...
        if (sVehicleNumber!!.isEmpty()) {
            Utils.showToast(requireContext(), "Please enter vehicle number")
            return false
        }
