...
import com.example.safehome.databinding.FragmentDeliveryAllowFrequentlyBinding
...
class DeliveryAllowFrequentlyFragment(private val visitorTypeId: Int? = null,
    ...
    private lateinit var binding: FragmentDeliveryAllowFrequentlyBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentDeliveryAllowFrequentlyBinding.inflate(inflater, container, false)
...
//                visitorOptionsMap["ApprovalStatusId"] = 1
    ...
    private fun categoryDropDown() {
        ...
        if (serviceProviderList.isNotEmpty()) {
            ...
            guestTypeAdapter.setCallbackDeliveryFrq(this@DeliveryAllowFrequentlyFragment)
        }
    ...
    private fun scheduleDropDown() {
        ...
        if (scheduleList.isNotEmpty()) {
            ...
            dropDownRecyclerView.adapter = guestTypeAdapter
            guestTypeAdapter.setCallbackDeliveryDate(this@DeliveryAllowFrequentlyFragment)
        }
