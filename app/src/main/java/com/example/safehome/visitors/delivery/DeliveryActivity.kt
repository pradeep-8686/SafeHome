...
class DeliveryActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        replaceFragment(R.id.fragment_container, DeliveryAllowOnceFragment(visitorTypeId, visitorListItem, approvalStatus))
    ...
    private fun buttonClickEvents() {
        ...
        binding.allowFrequentlyBtn.setOnClickListener {
            ...
            replaceFragment(R.id.fragment_container, DeliveryAllowFrequentlyFragment(visitorTypeId, visitorListItem, approvalStatus))
        }
    }
