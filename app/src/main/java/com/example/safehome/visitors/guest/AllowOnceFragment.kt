...
import com.example.safehome.visitors.InviteVisitorRequestModel
...
class AllowOnceFragment(
    ...
    override fun onCreateView(
        ...
        Log.e("approvalStatus", approvalStatus.toString())
        ...
        if (visitorListItem != null) {
            ...
            if (visitorListItem.name != null) {
                ...
                binding.etGuestName.text =
                    Editable.Factory.getInstance().newEditable(visitorListItem.name)
            }
            if (visitorListItem.mobileNo != null) {

                binding.etMobileNumber.text =
                    Editable.Factory.getInstance().newEditable(visitorListItem.mobileNo)
            }
            ...
            if (visitorListItem.inTime != null) {
                ...
                binding.startTimeText.text =
                    Editable.Factory.getInstance().newEditable(visitorListItem.inTime)
            }
    ...
    private fun clickEvents() {
        ...
        binding.btnSelectGuest.setOnClickListener {
            ...
            intent.putExtra("from", "AllowOnceFragment")
        ...
        binding.inviteBtn.setOnClickListener {
            ...
            if (validateData()) {
                ...
                Log.e("VisitorResponse", visitorOptionsMap.toString())
    ...
    private fun categoryDropDown() {
        ...
        if (serviceProviderList.isNotEmpty()) {
            ...
            guestTypeAdapter.setCallbackServiceType(this@AllowOnceFragment)
        }
