...
class StaffAllowFrequentlyFragment(private val visitorTypeId: Int? = null,
    ...
    private lateinit var binding: FragmentStaffAllowFrequentlyBinding
  ...
  //  private var scheduleId : Int ?= null
    ...
    override fun onCreateView(
        ...
        binding = FragmentStaffAllowFrequentlyBinding.inflate(inflater, container, false)
    ...
    private fun staffServiceBookedDropdown() {
        ...
        if (staffServiceBookedDropdownList.isNotEmpty()) {
            ...
            val contactAdapter = StaffServiceBookedAdapter(requireContext(), staffServiceBookedDropdownList, "staffFrequentlyFragment")

            staffServiceBookedRecyclerView.adapter = contactAdapter
            contactAdapter.setStaffAllowFrequentlyCallBAck(this@StaffAllowFrequentlyFragment)
        }
    ...
    private fun categoryDropDown() {
        ...
        if (serviceProviderList.isNotEmpty()) {
            ...
            guestTypeAdapter.setCallbackStaffFrq(this@StaffAllowFrequentlyFragment)
        }
    ...
    private fun scheduleDropDown() {
        ...
        if (scheduleList.isNotEmpty()) {
            ...
            dropDownRecyclerView.adapter = guestTypeAdapter
            guestTypeAdapter.setCallbackStaffDate(this@StaffAllowFrequentlyFragment)
        }
    ...
    fun setContact(bookedItem: StaffServiceBookedDropDownModel.Data) {
        if (bookedItem != null) {
