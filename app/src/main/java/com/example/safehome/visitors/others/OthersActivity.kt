...
import com.example.safehome.databinding.ActivityOthersBinding
...
class OthersActivity  : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        replaceFragment(R.id.fragment_container, OthersAllowOnceFragment(visitorTypeId, visitorListItem, approvalStatus))
    ...
    private fun buttonClickEvents() {
        ...
        binding.allowFrequentlyBtn.setOnClickListener {
            ...
            replaceFragment(R.id.fragment_container, OthersAllowFrequentlyFragment(visitorTypeId, visitorListItem, approvalStatus))
        }
    }
