...
import com.example.safehome.databinding.ActivityMeetingsBinding
...
class MeetingsActivity  : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        replaceFragment(R.id.vehicle_fragment_container, MeetingsUpcomingFragment())
    ...
    private fun buttonClickEvents() {
        ...
        binding.communityBtn.setOnClickListener {
            ...
            replaceFragment(R.id.vehicle_fragment_container, MeetingsCompletedFragment())
        }
    }
